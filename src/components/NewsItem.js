...
const NewsItem = (props) => {
  ...
  return (
    <div className="card" style={{ backgroundColor: '#f8f9fa' }}>
      ...
      <img
        src={!imgUrl ? "https://www.washingtonpost.com/wp-apps/imrs.php?src=https://arc-anglerfish-washpost-prod-washpost.s3.amazonaws.com/public/4CW7EIBYPAI63OFPBICOLXB5WY.jpg&w=1440" : imgUrl}
